/*
  ...
  - You are about to drop the column `firestore_id` on the `User` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "User_firestore_id_key";

-- AlterTable
ALTER TABLE "User" DROP COLUMN "firestore_id",
